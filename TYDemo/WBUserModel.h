 ...
 *  粉丝数
 */
@property(assign,nonatomic)NSInteger followers_count;//
/**
 *  关注数
 */
@property(assign,nonatomic)NSInteger friends_count;//
/**
 *  微博数
 */
@property(assign,nonatomic)NSInteger statuses_count;//
/**
 *  收藏数
 */
@property(assign,nonatomic)NSInteger favourites_count;//
/**
 *  用户创建（注册）时间
 */
...
/**
 *  -1普通用户;0名人,1政府,2企业,3媒体,4校园,5网站,6应用,7团体（机构）,8待审企业,10微博女郎,200初级达人,220中高级达人,400已故V用户。-1为普通用户，200和220为达人用户，0为黄V用户，其它即为蓝V用户
 */
 ...
 *  用户的在线状态，0：不在线、1：在线
 */
@property(assign,nonatomic)NSInteger online_status;//
/**
 *  用户的互粉数
 */
@property(assign,nonatomic)NSInteger bi_followers_count;//
/**
